...
import type { GetArticleResponse, GetRevisionHistoryResponseElement } from "@/shared/api/index.ts"
import { wikiApi } from "@/shared/service/wikiApiService.ts"
import RevisionHistoryList from "@/widgets/revision-history-list/ui.vue"
...
<template>
  <div class="flex flex-col w-full h-full">
    <div class="flex flex-row flex-wrap justify-content-center w-full">
      <RevisionHistoryList
